...
![Version: 1.0.2](https://img.shields.io/badge/Version-1.0.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.58.5](https://img.shields.io/badge/AppVersion-0.58.5-informational?style=flat-square)
...
| controllers.main.containers.main.image.tag | string | `"0.58.5"` | image tag |
