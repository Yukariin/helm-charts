...
![Version: 0.8.0](https://img.shields.io/badge/Version-0.8.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.67.0](https://img.shields.io/badge/AppVersion-v1.67.0-informational?style=flat-square)
...
| controllers.main.containers.autobrr.image.tag | string | `"v1.67.0"` | image tag |
