...
![Version: 0.4.2](https://img.shields.io/badge/Version-0.4.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.63.1](https://img.shields.io/badge/AppVersion-v1.63.1-informational?style=flat-square)
...
| controllers.main.containers.autobrr.image.tag | string | `"v1.63.1"` | image tag |
