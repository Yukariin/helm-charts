...
![Version: 1.1.4](https://img.shields.io/badge/Version-1.1.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.16.2944-ls297](https://img.shields.io/badge/AppVersion-4.0.16.2944--ls297-informational?style=flat-square)
...
| controllers.main.containers.main.image.tag | string | `"4.0.16.2944-ls297"` | image tag |
