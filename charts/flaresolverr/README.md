...
![Version: 0.4.10](https://img.shields.io/badge/Version-0.4.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.4.5](https://img.shields.io/badge/AppVersion-v3.4.5-informational?style=flat-square)
...
| controllers.main.containers.main.image.tag | string | `"v3.4.5"` | image tag |
